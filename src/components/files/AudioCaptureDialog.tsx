import { CheckIcon, HistoryIcon, MicIcon, XIcon } from "lucide-react";
...
export default function AudioCaptureDialog(props: AudioCaptureDialogProps) {
  ...
  return (
    <div
      className={`inset-0 bg-black/70 backdrop-blur transition-all ${
        show ? "visible opacity-100" : "invisible opacity-0"
      } fixed z-50 flex flex-col items-center justify-center gap-8 p-6 text-center`}
    >
        ...
        <div>
          ...
          <div className="mt-4 inline-flex items-center gap-2">
            <button
              ...
              id="save-recording"
            >
              <CheckIcon className="mr-2 text-lg" />
              {t("done")}
            </button>
            <button
            ...
            >
              <HistoryIcon className="mr-2 text-lg" />
